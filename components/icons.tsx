...
// Using a generic type for props to be flexible, but could be more specific
// if all icons share exact same props.
...
export const PortfolioIcon = (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M20 12v8a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V8"></path><path d="M22 6H12"></path><path d="M16 2L12 6l4 4"></path><path d="M4 12v-2a2 2 0 0 1 2-2h2"></path>
    </svg>
);
